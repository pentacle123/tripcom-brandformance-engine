      ...
      <div>
        <div style={{ marginBottom:16 }}>
          ...
          <div style={{ display:"flex", gap:8 }}>
            <span style={pill(`${C.secondary}12`,C.secondary,"")}>관심층 연간 14,000,000+회 | 해외 연결 연간 {fmt(2146916)}회 | 8개 기회 클러스터</span>
