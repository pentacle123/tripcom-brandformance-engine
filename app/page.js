    ...
    <div style={{ maxWidth:1200, margin:"0 auto", padding:"24px 24px 40px" }}>
      ...
      <div>
        ...
        <div style={{ background:"#FFFBEB", borderRadius:14, border:"1px solid #FDE68A", padding:16, marginBottom:16 }}>
          <div style={{ color:"#92400E", fontSize:13, fontWeight:700, marginBottom:10 }}>3E 전략 — Elderly · Event · Experience</div>
          <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr 1fr", gap:10 }}>
            <div style={{ background:"#FFFFFF", borderRadius:10, padding:12, border:"1px solid #FDE68A" }}>
              ...
              <div style={{ fontSize:11, color:C.text, lineHeight:1.5, marginBottom:6 }}>어버이날(400만)·환갑(71만)·칠순(24만) = 연 600만 감정 모먼트</div>
              <div style={{ fontSize:10, color:C.textSoft, lineHeight:1.4 }}>연결: 효도·어버이날·환갑, 골프, 한달살기, 크루즈<br/>Trip.com: 24시간 CS + 시니어 맞춤 + "여행이 최고의 선물"</div>
            </div>
            <div style={{ background:"#FFFFFF", borderRadius:10, padding:12, border:"1px solid #FDE68A" }}>
              <div style={{ fontSize:13, fontWeight:700, color:"#92400E", marginBottom:4 }}>🎪 Event — 이벤트 연결 여행</div>
              <div style={{ fontSize:11, color:C.text, lineHeight:1.5, marginBottom:6 }}>콘서트·마라톤·미식 = 전환 경로가 가장 짧은 여행</div>
              <div style={{ fontSize:10, color:C.textSoft, lineHeight:1.4 }}>연결: 이벤트+여행 연결자<br/>Trip.com: 이벤트 일정 연동 + 원스톱 예약</div>
            </div>
            <div style={{ background:"#FFFFFF", borderRadius:10, padding:12, border:"1px solid #FDE68A" }}>
              <div style={{ fontSize:13, fontWeight:700, color:"#92400E", marginBottom:4 }}>🏖️ Experience — 체험형 여행</div>
              <div style={{ fontSize:11, color:C.text, lineHeight:1.5, marginBottom:6 }}>크루즈·몽골 초원·발리 서핑 = 새로운 형태의 여행 경험</div>
              <div style={{ fontSize:10, color:C.textSoft, lineHeight:1.4 }}>연결: 크루즈, 몽골, 발리, 한달살기<br/>Trip.com: 원스톱 패키지 + Trip.Best 큐레이션</div>
            </div>
          </div>
        </div>
